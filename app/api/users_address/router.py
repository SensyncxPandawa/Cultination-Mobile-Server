...
@router.post("/users/{user_id}/pond_address", response_model=PondsSchema, tags=["Users' Address"])
...
@router.get("/users/{user_id}/primary_address", response_model=PrimarySchema, tags=["Users' Address"])
...
@router.get("/users/{user_id}/pond_address", response_model=List[PondsSchema], tags=["Users' Address"])
...
@router.get("/users/{user_id}/pond_address/{pond_address_id}", response_model=PondsSchema, tags=["Users' Address"])
...
# SET PRIMARY ADDRESS
@router.put("/users/{user_id}/primary_address", response_model=PrimarySchema, tags=["Users' Address"])
...
@router.put("/users/{user_id}/pond_address/{pond_address_id}", response_model=PondsSchema, tags=["Users' Address"])
...
@router.delete("/users/{user_id}/pond_address/{pond_address_id}", response_model=None, tags=["Users' Address"])
