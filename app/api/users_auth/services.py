...
def create_user(db: Session, user_auth: UsersAuth):
    ...
    existing_user = db.query(models.UsersAuth).filter(models.UsersAuth.user_phonenumber == user_auth.user_phonenumber).first()
...
def validate_user_auth(db: Session, user_validation_auth: UsersValidationAuth):
    # The function fetches a user's data using the user_phonenumber.
    existing_user = db.query(models.UsersAuth).filter_by(user_phonenumber=user_validation_auth.user_phonenumber).first()
