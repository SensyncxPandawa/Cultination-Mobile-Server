...
def create_user(user_auth: UsersAuth, db: Session = Depends(get_db)):
    """
    The function fetches a user's auth data using the user_phonenumber.
    ...
    \n The function returns the created user's auth data.
    """
...
def delete_user_by_id(user_id: int, db: Session = Depends(get_db)):
    ...
    \n It then delete the user's auth data
